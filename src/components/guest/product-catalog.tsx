...
export function ProductCatalog({ initialProducts, initialTotal, categories }: ProductCatalogProps) {
  ...
  return (
    <div className="flex flex-col gap-8 min-h-screen">
      <div className="sticky top-20 z-30 bg-background/80 backdrop-blur-md py-4 border-b border-border/40 transition-all">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <div className="relative flex-1 md:w-64">
              ...
              <Input
                ...
                className="pl-9 h-10 rounded-full bg-muted/50 border-transparent focus:bg-background focus:border-primary/50 transition-all"
                value={searchInput}
            ...
            <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
              <SheetTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className={cn("h-10 rounded-full px-5 gap-2 border-dashed border-foreground/30 hover:border-primary hover:text-primary transition-all", isFiltering && "border-primary text-primary bg-primary/5")}
                >
