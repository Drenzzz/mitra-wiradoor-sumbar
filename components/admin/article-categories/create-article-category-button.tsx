...
export function CreateArticleCategoryButton({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Tambah Kategori Artikel</DialogTitle>
          <DialogDescription>Isi detail untuk kategori artikel baru Anda.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
