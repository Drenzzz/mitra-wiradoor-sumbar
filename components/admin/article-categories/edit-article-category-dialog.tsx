  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    toast.promise(
      ...
      }),
      {
        ...
        success: () => { onSuccess(); onClose(); return 'Kategori berhasil diperbarui!'; },
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
            ...
            <DialogFooter><Button type="button" variant="outline" onClick={onClose}>Batal</Button><Button type="submit" disabled={isSubmitting}>{isSubmitting ? "Menyimpan..." : "Simpan Perubahan"}</Button></DialogFooter>
          </form>
        </Form>
      </DialogContent>
    </Dialog>
