    ...
    <Card className="overflow-hidden flex flex-col group">
      <CardHeader className="p-0">
        <Link href={`/artikel/${slug}`} className="block aspect-video relative w-full overflow-hidden">
          <Image src={article.featuredImageUrl} alt={article.title} fill className="object-cover transition-transform duration-300 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 50vw" />
        </Link>
      </CardHeader>
