  ...
  return (
    <div className="flex min-h-screen w-full bg-muted/40 relative">
      <Button
        ...
        className={cn("hidden md:inline-flex absolute top-1/2 -translate-y-1/2 z-20 h-7 w-7 transition-all duration-300 ease-in-out", isSidebarCollapsed ? "left-[50px]" : "left-[242px]")}
      >
